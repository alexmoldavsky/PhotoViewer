...
class PhotoItem extends PureComponent {
    ...
    render() {
      ...
      //  const likesCount = this.state.likesCount;
        ...
        return <div className="photo-item" onClick={this.onPhotoClick} style={{gridRowEnd: `span ${this.state.gridSpan}`}}>
    ...
    componentWillUnmount() {
        this.imgRef.removeEventListener('load', this.setSpans);
    }
    ...
    setSpans = () => {
        if (this.imgRef) {
           this.setState( {gridSpan: Math.ceil(this.imgRef.clientHeight / 10) + 2} );
        }
    }
